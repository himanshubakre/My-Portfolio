...
<html>
  <head>
    <meta charset="utf-8">
    <title>A-Frame Motion Capture Record</title>
    <meta name="description" content="Motion Capture Record – A-Frame">
  ...
  <body>
    <div class="container">
      <div class="sidebar">
        <h1>Record</h1>
        <p>Press space to start recording the position and orientation of the camera (you can move with Mouse + WASD keys). If you press space again the recorded data will replay.</p>
      </div>
